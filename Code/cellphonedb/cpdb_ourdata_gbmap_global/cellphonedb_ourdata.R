...
#combine datasets
se_combined.subset <- merge(se_m.subset, y = se_neo, add.cell.ids = c("microglial_cell", "neoplastic"))
...
file <- "matrix_cellphonedb_normalisation_ourdata.txt"
...
x2<-rep(c("neoplastic"),each=50) #glioblastoma 50 patients lab data
...
write.table(df3,"meta_cellphone_normalisation_ourdata.txt", row.names = FALSE, sep = "\t")

#post commands
#python commands
#with open('C:/Users/PAULA CAMARGO ROMERA/OneDrive - Uppsala universitet/Master/Uppsala University/Courses/Year 2/Thesis/processing/our_data/cellphonedb_results/meta_cellphone_normalisation_ourdata.txt', 'r', encoding='utf-8') as input_file:
#  lines = input_file.readlines()
#print(lines)
#with open('C:/Users/PAULA CAMARGO ROMERA/OneDrive - Uppsala universitet/Master/Uppsala University/Courses/Year 2/Thesis/processing/our_data/cellphonedb_results/meta_cellph_normalisation_ourdata.txt', 'w', encoding='utf-8') as output_file:
#  for line in lines:
#  output_file.write(line.replace('microglial\tcell', 'microglial_cell'))

#linux commands wsl
#sed -e 's/"//g' meta_cellph_normalisation_ourdata.txt > meta_normalisation_ourdata2.txt
