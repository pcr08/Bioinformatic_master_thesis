...
setwd('C:/Users/PAULA CAMARGO ROMERA/OneDrive - Uppsala universitet/Master/Uppsala University/Courses/Year 2/Thesis/processing/our_data/cellphonedb_results/bootstrap')
file <- "matrix_cellphonedb_normalisation_ourdata_bootstrap.txt"
write.table(data, file, append = FALSE, sep = "\t", dec = ".",
            row.names = TRUE, col.names = TRUE)

#metadata normalisation
setwd('C:/Users/PAULA CAMARGO ROMERA/OneDrive - Uppsala universitet/Master/Uppsala University/Courses/Year 2/Thesis/processing/our_data/cellphonedb_results/bootstrap')
x1<-rep(c("microglial cell"),each=26165) #microglial cell (TAM-MG) 26165
x2<-rep(c("neoplastic"),each=25050) #glioblastoma 50 patients lab data + 25000 noise

l1 <- str_split(se_combined.subset@assays$SCT@data@Dimnames[[2]], '"')
dd1 <- c(l1[1:26165])
dd2 <- c(l1[26166:26215])
v1 <- c(1:25000) #random names for the noise
dd2 <- c(dd2, v1)
...
write.table(df3,"meta_cellphone_normalisation_ourdata_bootstrap.txt", row.names = FALSE, sep = "\t")


#post commands
#python commands
#with open('C:/Users/PAULA CAMARGO ROMERA/OneDrive - Uppsala universitet/Master/Uppsala University/Courses/Year 2/Thesis/processing/our_data/cellphonedb_results/bootstrap/meta_cellphone_normalisation_ourdata_bootstrap.txt', 'r', encoding='utf-8') as input_file:
#  lines = input_file.readlines()
#print(lines)
#with open('C:/Users/PAULA CAMARGO ROMERA/OneDrive - Uppsala universitet/Master/Uppsala University/Courses/Year 2/Thesis/processing/our_data/cellphonedb_results/bootstrap/meta_cellp_normalisation_ourdata_bootstrap.txt', 'w', encoding='utf-8') as output_file:
#  for line in lines:
